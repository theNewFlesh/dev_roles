...
s0_alt_tab_forward = <Control>Tab
...
s0_run_command_terminal_key = <Control><Alt><Super>t
...
s0_toggle_window_maximized_key = <Control><Alt><Super>5
...
s0_zoom_in_key = <Control>equal
s0_zoom_out_button = Disabled
s0_zoom_out_key = <Control>minus
